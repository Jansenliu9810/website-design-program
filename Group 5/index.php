        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <!-- Check Cookie and login status end -->
...
<div class="container-fluid py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5" style="max-width: 500px;">
            <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Our Companies summary</h5>
            <h1 class="display-4">The Most Authoritative Official Information</h1>
        </div>
        <div class="owl-carousel team-carousel position-relative">
            <?php
            $reviewedCompany_list = getReviewedCompany();
            for ($i=0; $i<count($reviewedCompany_list); $i++): ?>
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        <div class="col-12 col-sm-5 h-100">
                            <img class="img-fluid h-100" src="img/company.jpg" style="...">
                        </div>
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3><?= $reviewedCompany_list[$i]->getName() ?></h3>
                                <h6 class="m-0 mb-4"><?= $reviewedCompany_list[$i]->getAddr() ?></h6>
                                <p class="m-0">
                                    <a href="<?= $reviewedCompany_list[$i]->getUrl() ?>">
                                        <?= $reviewedCompany_list[$i]->getUrl() ?>
                                    </a>
                                </p>
                            </div>
                            <div class="review">
                                <form name='company_review' method='get' action='review_employer.php'>
                                    ...
                                    <input type="hidden" name="company_id" value="<?= $reviewedCompany_list[$i]->getId() ?> " />
                                    <input type='submit' name="review" value='Review' class="reviewButtonIndex"/>
                                </form>
                            </div>
